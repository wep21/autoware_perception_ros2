...
Debugger::Debugger(const rclcpp::Node::SharedPtr & node) : node_(node)
{
  instance_pointcloud_pub_ =
    node_->create_publisher<sensor_msgs::msg::PointCloud2>("debug/instance_pointcloud", rclcpp::QoS(10));
}
